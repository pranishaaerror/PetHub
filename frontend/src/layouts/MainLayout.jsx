...
import { Menu, X, ChevronDown, TrendingUp, Users, Stethoscope, Scissors, Settings, LogOut, PawPrint, } from 'lucide-react';
...
export const MainLayout = () => {
  ...
  return (<div className="flex h-screen w-full overflow-hidden bg-[#FFF7EB]">
