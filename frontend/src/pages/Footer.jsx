    ...
    if (compact) {
        ...
        return (
            <div className="shrink-0 px-3 py-1.5 md:px-5">
                <footer className="rounded-[20px] bg-[#2D2D2D] px-4 py-2.5 text-white shadow-[0_12px_28px_rgba(45,45,45,0.12)]">
                    <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-[11px] text-white/75">
                        <span>© {year} PetHub</span>
                        {[...quickLinks, ...supportLinks].map((item) => (
